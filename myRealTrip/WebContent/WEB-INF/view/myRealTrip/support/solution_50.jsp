...
<!-- Title for the page -->
<title> 실시간 항공 : My Real Trip </title>
...
<!-- Meta information -->
      ...
      <meta name="author" content="" />  <link rel="canonical" href="https://help.myrealtrip.com/support/solutions/43000360290" /> 
...
<meta content="jSc6J4kgzViYeFKwpRn1ehto6NSMr3MY5+7S6Nn7iX8=" name="csrf-token" />
		...
		<script src="https://assets10.freshdesk.com/assets/cdn/portal_head-cc545c114f8f15358aa7acd4b9de11a5.js" type="text/javascript"></script>
		
		<!-- Including syntexhighlighter for portal -->
		<script src="https://assets7.freshdesk.com/assets/cdn/prism-67132b2e3f25bcb9d275fd76bf59f43c.js" type="text/javascript"></script>
  ...
  <div class="container">
    <div class="container-inner">
      ...
      <div class="folder-tree">
              ...
              <c:forEach var="i" begin="12" end="16" step="1">
           ...
           <!-- title  -->
             <c:choose>
                      ...
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=12&ac_code=50">예약</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 13}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=13&ac_code=50">결제&발권</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 14}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=14&ac_code=50">취소&환불&변경</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 15}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=15&ac_code=50">여권&증빙&비자</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 16}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=16&ac_code=50">기타문의</a>
                      </h3>
                      </c:when>
