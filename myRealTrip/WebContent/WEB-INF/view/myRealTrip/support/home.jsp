...
<meta content="nDiUud7lsCFxNk7BQBwlIDsZfH8dpSfFR2S2UKf7FOA=" name="csrf-token" />
		...
		<link href="https://assets6.freshdesk.com/assets/cdn/portal_print-ce4892062f25ebaf8abdcca87f6225b0.css" media="print" rel="stylesheet" type="text/css" />
		...
		<script src="https://assets5.freshdesk.com/assets/cdn/portal_head-cc545c114f8f15358aa7acd4b9de11a5.js" type="text/javascript"></script>
...
<div class="layout layout--anonymous  layout--portal_home">
...
<jsp:include page="/WEB-INF/layout/helpTop.jsp"></jsp:include>
        ...
        <section class="hero-unit" data-hero-unit>
          <div class="hero-unit__bg">
            <div class=" search-box search-box--hero-unit" data-search-box>
              ...
              <form class="hc-search-form" autocomplete="off" action="<%= request.getContextPath() %>/myrealtrip/support/search.do" id="hc-search-form">
	...
	<label for="support-search-input" class="hide">궁금한 내용, 질문, 오류상황 등 검색어를 입력하세요.</label>
		<input placeholder="궁금한 내용, 질문, 오류상황 등 검색어를 입력하세요." type="text" 
			name="searchWord" class="special" value="" 
  ...
  <div class="container-inner">
    ...
    <div class="category-tree" id="category-tree">
          ...
          <section class="category-tree-item">
            <h2 class="h3 category-tree-item__title">
              자주 묻는 질문
            </h2>
            <div class="category-tree-item__folders row clearfix">
                ...
                <section class="column column--md-6 folder">
                  <h3 class="h5 folder__title">
                    예약방법
                  </h3>
                  <ul class="articles">
                   ...
                   <li class="articles__item">
                      <a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=1&ac_code=20" class="see-all-articles">
                        ${ count.ecdN }개의 질문 모두 보기  <img ckass="arrow-icon" width="16" height="16" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png" srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png 1x,https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24%402x.png 2x"alt="">
                      </a>
                    </li> 
                      </c:if>
                      </c:forEach>
                ...
                <section class="column column--md-6 folder">
                  ...
                  <ul class="articles">
                   ...
                   <li class="articles__item">
                      <a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=12&ac_code=20" class="see-all-articles">
                         ${ count.ecdN }개의 질문 모두 보기  <img ckass="arrow-icon" width="16" height="16" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png" srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png 1x,https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24%402x.png 2x"alt="">
                      </a>
                    </li> 
                      </c:if>
      ...
      <div class="category-tree__button text-center">
        <a class="btn btn-secondary" href="<%=request.getContextPath() %>/myrealtrip/support/home.do?key=solution" data-category="0" id="10">자주 묻는 질문 모두 보기</a>
      </div>
    </div>

    <div class="footer-blocks">
      <h3 class="footer-blocks__title">마이리얼트립이 처음이신가요?</h3>
      <a target="_blank" class="footer-block footer-block--primary" href="https://www.myrealtrip.com/about/howitworks">
        <h4 class="footer-block__title">이용방법</h4>
        <div class="footer-block-description">
          항공권 예약, 숙소 그리고 현지투어와 명소 입장권까지 쉽고 빠르게 이용할 수 있는 방법을 알아보세요.
        </div>
        <img width="32" height="32" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-gray-20.png" srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-gray-32.png 1x, https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-gray-32%402x.png 2x" class="footer-block__arrow" />
      </a>
      <a target="_blank" class="footer-block footer-block--secondary" href="https://about.myrealtrip.com">
        <h4 class="footer-block__title">회사소개</h4>
        <div class="footer-block-description">
          마이리얼트립에 대해 알고 싶으신가요? 여행을 통해 세상을 경험해보세요.
        </div>
        <img width="32" height="32" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-gray-20.png"
        srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-gray-32.png 1x, https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-gray-32%402x.png 2x"
           class="footer-block__arrow" />
      </a>
    </div>
  </div>
</div>
        ...
        <div class="footer-buttons ">
          ...
          <span class="footer-buttons__items">
            ...
            <span><!--20190516 by WeDoSoft -->
              ...
              <a href="<%= request.getContextPath() %>/myRealTrip/support/solution/question.do" class="btn btn-outline">문의하기</a>
            </span>
          </span>
        </div>
      </div>
  ...
  <jsp:include page="/WEB-INF/view/myRealTrip/support/bottom.jsp"></jsp:include>
</div>
...
<script>
  (function($) {
    ...
    $('.topbar a[href*="/support/profile/edit"]').parent('b').remove();
	    ...
	    <script src="https://assets8.freshdesk.com/assets/cdn/portal_bottom-fccb8c9aa071a0847726c1bb17225e9c.js" type="text/javascript"></script>
		<script src="https://assets6.freshdesk.com/assets/cdn/redactor-b5af0e7719dcfa84e7abd758b50900d3.js" type="text/javascript"></script>
		<script src="https://assets6.freshdesk.com/assets/cdn/freshfone_portal-c77b4da36df17dff45d679dc64445f39.js" type="text/javascript"></script>	
		<script src="https://assets4.freshdesk.com/assets/cdn/lang/ko-c62c7d023f5cecf863628fa3fce02dd5.js" type="text/javascript"></script>
		<!-- for i18n-js translations -->
  		<script src="https://assets9.freshdesk.com/assets/cdn/i18n/portal/ko-6411c85399930b87a1ee8ed7aca135ac.js" type="text/javascript"></script>
