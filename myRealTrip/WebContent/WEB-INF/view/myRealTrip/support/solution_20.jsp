...
<!-- Title for the page -->
<title> 예약·변경·취소 : My Real Trip </title>
...
<!-- Meta information -->
      ...
      <meta name="author" content="" />  <link rel="canonical" href="https://help.myrealtrip.com/support/solutions/43000360286" /> 
...
<meta content="x8jqwMjmIUQaIH+j8RPFRsc2xfyC8/G/hmd0eSYyKPE=" name="csrf-token" />
		...
		<link href="https://assets3.freshdesk.com/assets/cdn/portal_print-ce4892062f25ebaf8abdcca87f6225b0.css" media="print" rel="stylesheet" type="text/css" />
...
<div class="layout layout--anonymous  layout--solution_category">
          ...
          <section class="folder">
           <!-- title  -->
             <c:choose>
                      ...
                      <c:when test="${ i eq 2}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=2&ac_code=20">결제하기</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 3}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=3&ac_code=20">최소환불</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 4}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=4&ac_code=20">예약변경</a>
                      </h3>
                      </c:when>
                    </c:choose>
            <!-- title -->
              ...
              <ul class="articles">
				...
				<c:if test="${ dto.acd_code eq i }">
				  <li class="articles__item"> 
                   <a class="articles__link" href="<%= request.getContextPath() %>/myrealtrip/support/solution/articles.do?fs_code=${ dto.fs_code }">${ dto.fs_title }</a> 
                 <%--  <li class="articles__item articles__link" value="1" id="예약방법">${ dto.fs_title }</li> --%>
                 </li> 
                </c:if> 
				</c:forEach>
				
				
                <!-- <li class="solutionmore" value="1" id="예약방법">더보기 ></li> -->
                
                <li class="solutionmore" value="1" id="예약방법"><a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=${ i}&ac_code=${param.ac_code}" class="see-all-articles">
                    더보기 <img ckass="arrow-icon" width="16" height="16" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png"
...
<script>
  (function($) {
    ...
    $('.topbar a[href*="/support/profile/edit"]').parent('b').remove();
	    ...
	    <script src="https://assets5.freshdesk.com/assets/cdn/portal_bottom-fccb8c9aa071a0847726c1bb17225e9c.js" type="text/javascript"></script>
		...
		<script src="https://assets10.freshdesk.com/assets/cdn/lang/ko-c62c7d023f5cecf863628fa3fce02dd5.js" type="text/javascript"></script>
		<!-- for i18n-js translations -->
  		<script src="https://assets4.freshdesk.com/assets/cdn/i18n/portal/ko-6411c85399930b87a1ee8ed7aca135ac.js" type="text/javascript"></script>
...
<script>/*  <a class="folder__title-link" href="#"   id="1">예약방법</a>  */
										
			
			/* $(".folder__title-link")
					.onclick(function() {
										  /* event.isDefaultPrevented();  */
						/* location.replace = "/jspPRO/myrealtrip/support/folders.do?acd_code="
										+ $(this).attr("id") + "&title=" + $(this).html(); */
						
						/*$(this).attr("href","/jspPRO/myrealtrip/support/folders.do?acd_code="
								+ this.id+ "&title="+ $(this).html());
	...
	<script>
		$(".solution")
				.on(
						"click",
						function() {
							location.href = "myRealTrip/myrealtrip/support/solution.do?ac_code="
									+ this.id;
						})
		$(".solutionmore")
				.on(
						"click",
						function() {
							location.href = "myRealTrip/myrealtrip/support/folders.do?acd_code="
									+ this.value + "&title=" + this.id;
						})
		$(".solutionhome").on("click", function() {
			location.href = "myRealTrip/myrealtrip/support/home.do?key=solution";
		})
	</script>
		<script type="text/javascript">
