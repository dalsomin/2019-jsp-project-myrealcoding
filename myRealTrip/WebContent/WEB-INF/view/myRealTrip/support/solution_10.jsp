...
<!-- Meta information -->
      ...
      <meta name="author" content="" />  <link rel="canonical" href="https://help.myrealtrip.com/support/solutions" /> 
...
<meta content="OMnDmPUHMxODFqjPeJHBEpa/Il8Mtcof37v0WKjxXGI=" name="csrf-token" />
		...
		<link href="https://assets1.freshdesk.com/assets/cdn/portal_print-ce4892062f25ebaf8abdcca87f6225b0.css" media="print" rel="stylesheet" type="text/css" />
	  		<link href="https://assets5.freshdesk.com/assets/cdn/falcon_portal_utils-fc010ba819d2d80256daa9858dbbc765.css" media="screen" rel="stylesheet" type="text/css" />	
		...
		<script src="https://assets1.freshdesk.com/assets/cdn/portal_head-cc545c114f8f15358aa7acd4b9de11a5.js" type="text/javascript"></script>
		
		<!-- Including syntexhighlighter for portal -->
		<script src="https://assets1.freshdesk.com/assets/cdn/prism-67132b2e3f25bcb9d275fd76bf59f43c.js" type="text/javascript"></script>
...
<div class="layout layout--anonymous  layout--solution_home">
...
<div class="solutions-home-page">
  <div class="solutions-home-page__hero">
    <div class="solutions-home-page__container">
      <h1 class="solutions-home-page__title text-center">자주 묻는 질문</h1>
    </div>
  </div>
      ...
      <div class="category-tree" id="category-tree">
              ...
              <div class="category-tree-item">
                ...
                <div class="category-tree-item__folders row clearfix">
                    ...
                    <div class="column column--md-6 folder">
                    
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=1&ac_code=20">예약방법</a>
                      </h3>
                      <ul class="articles">
             <c:forEach items="${list}" var="dto">
                    ...
                    <c:if test="${ count.acd_code eq 1 }">
                        <li class="articles__item">
                          <a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=1&ac_code=20" class="see-all-articles">
                            ${ count.ecdN }개의 질문 모두 보기 <img ckass="arrow-icon" width="16" height="16" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png"
                                srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png 1x,https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24%402x.png 2x"
                                alt="">
                          </a>
                        </li>
                        </c:if>
                    ...
                    <div class="column column--md-6 folder">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=3ac_code=20">취소환불</a>
                      </h3>
                     ...
                     <c:forEach items="${ count }" var="count">
                    <c:if test="${ count.acd_code eq 3 }">
                        <li class="articles__item">
                          <a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=3&ac_code=20" class="see-all-articles">
                            ${ count.ecdN }개의 질문 모두 보기 <img ckass="arrow-icon" width="16" height="16" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png"
                                srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png 1x,https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24%402x.png 2x"
                                alt="">
                          </a>
                    ...
                    <div class="column column--md-6 folder">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=9ac_code=20">혜택</a>
                      </h3>
                    ...
                    <c:forEach items="${ count }" var="count">
                    <c:if test="${ count.acd_code eq 9 }">
                        <li class="articles__item">
                          <a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=9&ac_code=40" class="see-all-articles">
                            ${ count.ecdN }개의 질문 모두 보기 <img ckass="arrow-icon" width="16" height="16" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png"
                                srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png 1x,https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24%402x.png 2x"
                                alt="">
                          </a>
                    ...
                    <div class="column column--md-6 folder">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=5ac_code=30">프로필</a>
                      </h3>
                     ...
                     <c:forEach items="${ count }" var="count">
                    <c:if test="${ count.acd_code eq 5 }">
                        <li class="articles__item">
                          <a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=5&ac_code=30" class="see-all-articles">
                            ${ count.ecdN }개의 질문 모두 보기 <img ckass="arrow-icon" width="16" height="16" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png"
                                srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png 1x,https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24%402x.png 2x"
                                alt="">
                          </a>
                    ...
                    <div class="column column--md-6 folder">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=12">항공 관련</a>
                      </h3>
                     ...
                     <c:forEach items="${ count }" var="count">
                    <c:if test="${ count.acd_code eq 12 }">
                        <li class="articles__item">
                          <a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=12&ac_code=50" class="see-all-articles">
                            ${ count.ecdN }개의 질문 모두 보기 <img ckass="arrow-icon" width="16" height="16" src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png"
                                srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png 1x,https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24%402x.png 2x"
                                alt="">
                          </a>
      ...
      <div class="other-categories">
        <ul class="other-categories__list">
            ...
            <li class="other-categories__item">
              <h4 class="h5 other-categories__title">자주 묻는 질문</h4>
              <ul class="other-folders">
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000554114" class="other-folders__title">공지사항</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000546697" class="other-folders__title">예약방법</a>
                </li>                           
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000549993" class="other-folders__title">취소환불</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000553548" class="other-folders__title">혜택</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000549994" class="other-folders__title">프로필</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000549995" class="other-folders__title">항공 관련</a>
                </li>
            ...
            <li class="other-categories__item">
              <h4 class="h5 other-categories__title">예약·변경·취소</h4>
              <ul class="other-folders">
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000549996" class="other-folders__title">예약방법</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000549997" class="other-folders__title">결제하기</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000549998" class="other-folders__title">취소환불</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000549999" class="other-folders__title">예약변경</a>
                </li>
            ...
            <li class="other-categories__item">
              <h4 class="h5 other-categories__title">가입·변경·탈퇴</h4>
              <ul class="other-folders">
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550000" class="other-folders__title">프로필</a>
                </li>
            ...
            <li class="other-categories__item">
              <h4 class="h5 other-categories__title">이용·후기·혜택</h4>
              <ul class="other-folders">
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550004" class="other-folders__title">일반문의</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000554883" class="other-folders__title">상품문의</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550002" class="other-folders__title">이용후기</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000553550" class="other-folders__title">혜택</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550001" class="other-folders__title">여행가기</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550003" class="other-folders__title">오류</a>
                </li>
            ...
            <li class="other-categories__item">
              <h4 class="h5 other-categories__title">실시간 항공</h4>
              <ul class="other-folders">
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550010" class="other-folders__title">예약</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550011" class="other-folders__title">결제&발권</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550012" class="other-folders__title">취소&환불&변경</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550013" class="other-folders__title">여권&증빙&비자</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550014" class="other-folders__title">기타문의</a>
                </li>
            ...
            <li class="other-categories__item">
              <h4 class="h5 other-categories__title">파트너</h4>
              <ul class="other-folders">
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550005" class="other-folders__title">가이드(파트너) 등록</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550006" class="other-folders__title">상품등록</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550007" class="other-folders__title">예약관리</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550008" class="other-folders__title">정산(송금)</a>
                </li>
                
                <li class="other-folders__item">
                  <a href="/support/solutions/folders/43000550009" class="other-folders__title">좋은가이드되기</a>
                </li>
...
<script>
  (function($) {
    ...
    $('.topbar a[href*="/support/profile/edit"]').parent('b').remove();
		...
		<script src="https://assets2.freshdesk.com/assets/cdn/redactor-b5af0e7719dcfa84e7abd758b50900d3.js" type="text/javascript"></script>
		<script src="https://assets10.freshdesk.com/assets/cdn/freshfone_portal-c77b4da36df17dff45d679dc64445f39.js" type="text/javascript"></script>	
		...
		<!-- for i18n-js translations -->
  		<script src="https://assets2.freshdesk.com/assets/cdn/i18n/portal/ko-6411c85399930b87a1ee8ed7aca135ac.js" type="text/javascript"></script>
