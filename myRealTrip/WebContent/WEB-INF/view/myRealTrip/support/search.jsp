...
<!-- Meta information -->
      ...
      <meta name="author" content="" />  <link rel="canonical" href="https://help.myrealtrip.com/support/search" /> 
...
<meta content="180o87VLXMjzjy0RKLASNrZlOt6v9fNGNlzXNGhSbiU=" name="csrf-token" />
		...
		<link href="https://assets8.freshdesk.com/assets/cdn/portal_print-ce4892062f25ebaf8abdcca87f6225b0.css" media="print" rel="stylesheet" type="text/css" />
	  		<link href="https://assets1.freshdesk.com/assets/cdn/falcon_portal_utils-fc010ba819d2d80256daa9858dbbc765.css" media="screen" rel="stylesheet" type="text/css" />	
...
<div class="layout layout--logged-in  layout--search">
  ...
  <jsp:include page="/WEB-INF/layout/helpTop.jsp"></jsp:include>
	...
	<label for="support-search-input" class="hide">궁금한 내용, 질문, 오류상황 등 검색어를 입력하세요.</label>
		<input placeholder="궁금한 내용, 질문, 오류상황 등 검색어를 입력하세요." type="text" 
			name="searchword" class="special" id="support-search-input">
<!-- 		<input placeholder="궁금한 내용, 질문, 오류상황 등 검색어를 입력하세요." type="text" 
			name="searchword" class="special"  
...
<div class="search-results-page container">
    <div class="search-results container-inner">
      <h1 class="search-results-count">다음에 대한 검색 결과: "${ sw }"</h1>
      
        <ul class="list-unstyled search-results__list">
            <c:forEach items="${ articlePage.content }" var="dto">
            <li class="search-result">
              <h3 class="h6 search-result__title">
                <a href="<%= request.getContextPath() %>/myrealtrip/support/solution/articles.do?fs_code=${ dto.fs_code }" class="search-result__link">
               <!--  <span class="match">중국</span> 여행 시 비자가 있어야 하나요?</a> -->
               ${ dto.fs_title }
               </a>
              </h3>

              <p class="search-result__description">
              <!--  <span class="match">중국지역으로의</span> 한국인 출국 고객은 출국 전 개별적으로 비자를 발급받으셔야 합니다.   <span class="match">중국대사관</span> 연락처 : 02-738-1038(최소 출발 일주일 -->
               ${ dto.fs_answer }
               </p>
          ...
          <div class="pagination pagination-centered">
             ...
             <li class="previous disabled">
              <c:if test="${articlePage.startPage > 5}">
               <a href="folders.do?pageNo=${articlePage.startPage - 5}">&laquo; Previous </a>
                </c:if> 
             </li>
             ...
             <c:forEach var="pNo" 
              ...
              <a  rel="next"  href="/search.do?&pageNo=${pNo}&searchword="${ sw }">${pNo}</a>
             	</c:forEach>
             </li>
             <li class="next_page">
             	<c:if test="${articlePage.endPage < articlePage.totalPages}">
              <a rel="next" href="folders.do?pageNo=${articlePage.startPage +5}">Next &raquo;</a>
              </c:if>
              </li>
             </ul>
    ...
    <div class="container">
      <div class="container-inner">
        <div class="footer-buttons footer-buttons--contacts">
          <span class="footer-buttons__text">
          
            <span class="footer-buttons__title">고객센터 대표번호 <b>1670-8208</b></span>
            <span class="footer-buttons__time">일반문의 9:00~22:00 (연중무휴)</span> 
            <span class="footer-buttons__time">항공문의 9:00~18:00 (연중무휴)</span>
            <span class="footer-buttons__time">점심시간 12:00~13:00</span>
...
<script>
  (function($) {
    ...
    $('.topbar a[href*="/support/profile/edit"]').parent('b').remove();
	    ...
	    <script src="https://assets1.freshdesk.com/assets/cdn/portal_bottom-fccb8c9aa071a0847726c1bb17225e9c.js" type="text/javascript"></script>
		...
		<script src="https://assets1.freshdesk.com/assets/cdn/lang/ko-c62c7d023f5cecf863628fa3fce02dd5.js" type="text/javascript"></script>
