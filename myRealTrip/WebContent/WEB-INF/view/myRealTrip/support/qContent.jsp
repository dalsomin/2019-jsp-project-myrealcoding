...
<!-- Title for the page -->
<title> [#371168] 문의내역은 어디서 확인할 수 있나요? : My Real Trip </title>
...
<!-- Meta information -->
      ...
      <meta name="author" content="" />  <link rel="canonical" href="https://help.myrealtrip.com/support/tickets/371168" /> 
...
<meta content="BmGd7UEuvOB3KCx8MF/KgNdl+Ud2FLRfOrDuU0P/kdg=" name="csrf-token" />
		...
		<link href="https://assets9.freshdesk.com/assets/cdn/portal_print-ce4892062f25ebaf8abdcca87f6225b0.css" media="print" rel="stylesheet" type="text/css" />
	  		<link href="https://assets10.freshdesk.com/assets/cdn/falcon_portal_utils-fc010ba819d2d80256daa9858dbbc765.css" media="screen" rel="stylesheet" type="text/css" />	
	...
	<!-- google analytices ends here -->
		...
		<!-- Access portal settings information via javascript -->
		 <script type="text/javascript">     var portal = {"language":"ko","name":"My Real Trip","contact_info":"","current_page_name":"ticket_view","current_tab":"tickets","preferences":{"bg_color":"#f3f5f7","header_color":"#ffffff","help_center_color":"#f3f5f7","footer_color":"#183247","tab_color":"#ffffff","tab_hover_color":"#42a5f5","btn_background":"#f3f5f7","btn_primary_background":"#42a5f5","baseFont":"Source Sans Pro","textColor":"#183247","headingsFont":"Poppins","headingsColor":"#183247","linkColor":"#183247","linkColorHover":"#2753d7","inputFocusRingColor":"#42a5f5","nonResponsive":"true","personalized_articles":true},"image_placeholders":{"spacer":"https://assets2.freshdesk.com/assets/misc/spacer.gif","profile_thumb":"https://assets10.freshdesk.com/assets/misc/profile_blank_thumb-e1a34033b3073cb80f5becc0b644bfca.jpg","profile_medium":"https://assets6.freshdesk.com/assets/misc/profile_blank_medium-4ae2280a460eae3c870acb7a7545b7e5.jpg"},"falcon_portal_theme":true};     var attachment_size = 20;  </script> 
...
<div class="layout layout--logged-in  layout--ticket_view">
  ...
  <div class="layout__content">
    ...
    <!--20190411 added by WeDoSoft 문구수정, 로그인한 사용자만 적용-->
<script language="javascript">
  jQuery('#notice')[0].childNodes[2].nodeValue = "문의가 접수되어 사본이 귀하의 이메일로 전송되었습니다."
</script>
  ...
  <div class="container">
    <div class="container-inner">
      <ol class="breadcrumbs">
        ...
        <li title="티켓 목록">
          <a href="/support/tickets">티켓 목록</a>
        </li>
      </ol>

      <section class="ticket-column">
        
        <div class="toolbar-actions hidden" id="ticket-toolbar">
          
          <a href="#reply-to-ticket" class="btn btn-default" data-proxy-for="#add-note-form"
             title="답장" data-toggle="tooltip">
            <i class="fa fa-reply" aria-hidden="true"></i>
          </a>
          <a href="/support/tickets/371168/close" data-method="post" class="btn btn-default"
             data-toggle="tooltip" title="티켓을 종료됨으로 표시">
            <i class="fa fa-check-circle" aria-hidden="true"></i>
          </a>
          <a href="#add-people" rel="freshdialog" data-width="400" class="btn btn-default"
             data-submit-label="사람 추가"
             data-toggle="tooltip" data-close-label="닫기"
             title="사람 추가">
        ...
        <div class="ticket__info">
          ...
          <h1 class="ticket__subject">${ qdto.cq_title }</h1>

          <div class="ticket__meta">
            <span class="ticket__meta-item"> <span class='timeago' title='${ qdto.cq_date }' >
			${ qdto.cq_date }
		   </span>  · ${ qdto.cq_code }</span>
		   
		   



             <c:if test="${qdto.ql_s_code eq 3 }"> 
             
            <span class="label-status-이-티켓은-해결되었습니다. label label-small label--ticket-status">
              이-티켓은-해결되었습니다.
            </span>
          </c:if>
            
            <c:if test="${qdto.ql_s_code eq 2 }"> 
            <span class="label-status-처리-중 label label-small label--ticket-status">
              처리-중
            </span>
              </c:if> 
          ...
          <div class="ticket__desc">
            <div dir="ltr"><div>${ qdto.cq_detail }</div></div>
     ...
     <%-- <c:forEach items="${ qdto }" var="qdto" varStatus="status" > 
...
<div id="ticket-comments" class="comments" >
            ...
            <li class="comment" >
              <div class="comment__inner">
                <div class="comment__avatar">
                  <div class="avatar">
                      <div class="user-pic-thumb image-lazy-load user-avatar user-avatar--default"> <div class="thumb avatar-text circle text-center bg-9"> 표  </div> </div> 
                  </div>
                </div>
...
<div dir="ltr">${param.qa_content }<div>
<img id="cursor" width="0" height="0" rel="cursor" class="fr-fic fr-dii"><br>
</div></div>
<div dir="ltr"><div><br></div></div>
           ...
           <c:forEach items="${ listQ }" var="list" >
           
            <li class="comment" >
              <div class="comment__inner">
                <div class="comment__avatar">
                  <div class="avatar">
                      <div class="user-pic-thumb image-lazy-load user-avatar user-avatar--default"> <div class="thumb avatar-text circle text-center bg-3"> ${ qdto.cq_name } </div> </div> 
                  </div>
                </div>
                
                
                <div class="comment__content">
                  <div class="comment__body"><div dir="ltr"><div>${list.qa_content }</div></div></div>

                  <div class="comment__meta"><span class='timeago' >${list.qa_date }</span></div>
        ...
        <div class="comment-form">
          <div class="comment-form__avatar">
            <div class="avatar avatar--comment">
                <div class="user-pic-thumb image-lazy-load user-avatar user-avatar--default"> <div class="thumb avatar-text circle text-center bg-3"> 지  </div> </div> 
            </div>
          </div>
          ...
          <!-- 답장하기!!!!! -->
<form accept-charset="UTF-8" action="<%= request.getContextPath() %>/myRealTrip/support/solution/qComment.do?cq_code=${ qdto.cq_code }" class="new_helpdesk_note"  id="new_helpdesk_note" method="post" rel="validate"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="BmGd7UEuvOB3KCx8MF/KgNdl+Ud2FLRfOrDuU0P/kdg=" /></div>
		  	
	  	<div class="row-fluid">
			<p class="span12">
				
	  				<textarea class="redactor-textarea required2" 
	  				 height="150px" id="helpdesk_note_note_body_attributes_body_html" 
	  				name="qa_content" rel="redactor" style="height:150px;">
                   </textarea>
<!-- <script type="text/javascript">
                      if( jQuery.browser.desktop ){
                        ...
                        !function( $ ) {
                          $(function() {
                            ...
                            var redactorOptions = {"focus":true,"autoresize":false,"tabindex":2,"convertDivs":false,"allowTagsInCodeSnippet":true,"imageUpload":"/tickets_uploaded_images","clipboardImageUpload":"/tickets_uploaded_images/create_file","buttons":["bold","italic","underline","|","unorderedlist","orderedlist","|","fontcolor","backcolor","|","link","image"],"editor-type":"ticket","class":"required","height":"150px","id":"helpdesk_note_note_body_attributes_body_html"};
                            if(imageUploadTypes.indexOf("ticket") !== -1){
                              redactorOptions = jQuery.extend({}, redactorOptions, { imageUploadCallback: inlineImageUploadCallback });
                            }
                            window.redactors['helpdesk_note_note_body_attributes_body_html'] = $('#helpdesk_note_note_body_attributes_body_html').redactor(redactorOptions);
                          })  
                        }(window.jQuery);
                      }
                  </script> -->
...
<div class="attach-wrapper row-fluid new-attach" id="attachment-type" data-multifile-enable="true" data-location="portal">
  <div class="attachments-list-wrap">
    <div class="attachments-list-form" id="371168-container">
      
      <div class="attachment_contents">
        <div id="371168-attachments" class="attachments-wrap shared_attachment_list">
    ...
    <div class="clearfix"></div>
      ...
      <div class="add_attachment"><span>+</span> 파일 첨부</div>
        <input type="file" name="emptyfile"
                    id="371168_file"
                    data-attach-id="371168"
                    nameWhenFilled="helpdesk_note[attachments][][resource]"
                    fileContainer="371168-container"
                    fileList="371168-attachments"
                    sendFocusTo="371168-body"
                    max_size="20"
                    max_attachment= ""
                    >
      </div>
  ...
  <div class="item">
    ...
    <script type="text/javascript">
      ...
      jQuery('li.portal-attach a.attach-link-wrap')
		...
		<input class="btn btn-primary" id="helpdesk_note_submit" name="commit" type="submit" value="답장" />
		<a href="#" data-hide-dom="#add-note-form" data-show-dom="#add-note-form-proxy" class="btn">취소</a>
</form>
          </div>
        </div>
      </section>
...
<div id="add-people" class="hide">
	<div class="alert">이 티켓에 대한 알림을 전송할 때 복사해야 할 이메일을 추가하거나 제거하십시오.</div>
	<form accept-charset="UTF-8" action="/support/tickets/371168/add_people" class="edit_helpdesk_ticket" id="edit_helpdesk_ticket_43075134066" method="post" rel="validate"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="_method" type="hidden" value="put" /><input name="authenticity_token" type="hidden" value="BmGd7UEuvOB3KCx8MF/KgNdl+Ud2FLRfOrDuU0P/kdg=" /></div>	

		
			<input class="span12" id="cc_emails" name="helpdesk_ticket[cc_email][reply_cc]" size="30" type="text" />
</form></div>
...
<script>
  (function($) {
    ...
    $('.topbar a[href*="/support/profile/edit"]').parent('b').remove();
	    ...
	    <script src="https://assets2.freshdesk.com/assets/cdn/portal_bottom-fccb8c9aa071a0847726c1bb17225e9c.js" type="text/javascript"></script>
		<script src="https://assets5.freshdesk.com/assets/cdn/redactor-b5af0e7719dcfa84e7abd758b50900d3.js" type="text/javascript"></script>
		...
		<!-- for i18n-js translations -->
  		<script src="https://assets7.freshdesk.com/assets/cdn/i18n/portal/ko-6411c85399930b87a1ee8ed7aca135ac.js" type="text/javascript"></script>
