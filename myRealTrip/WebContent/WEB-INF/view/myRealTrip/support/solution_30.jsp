...
<!--[if (gt IE 10)|!(IE)]><!-->
<html class="no-js " lang="ko" dir="ltr" data-date-format="non_us">
<!--<![endif]-->
<head>
...
<!-- Title for the page -->
<title>가입·변경·탈퇴 : My Real Trip</title>
...
<link rel="canonical"
	href="https://help.myrealtrip.com/support/solutions/43000360287" />
...
<meta content="jveJmAu2zhOAYmaEjCFigHob8pHmrQpeIFu4A3sNeEU="
	name="csrf-token" />
<!-- End meta tag for CSRF token -->

<!-- Fav icon for portal -->
<link rel='shortcut icon'
	href='https://s3.amazonaws.com/cdn.freshdesk.com/data/helpdesk/attachments/production/43012081607/fav_icon/NANmpYF61XxoCxNkRbbT7U4CdPT7Gbd5ZA.ico' />

<!-- Base stylesheet -->

<link
	href="https://assets4.freshdesk.com/assets/cdn/portal_print-ce4892062f25ebaf8abdcca87f6225b0.css"
	media="print" rel="stylesheet" type="text/css" />
<link
	href="https://assets10.freshdesk.com/assets/cdn/falcon_portal_utils-fc010ba819d2d80256daa9858dbbc765.css"
	media="screen" rel="stylesheet" type="text/css" />


<!-- Theme stylesheet -->

<link href="https://help.myrealtrip.com/support/theme.css?v=1557997475"
	media="screen" rel="stylesheet" type="text/css">

<!-- Google font url if present -->
<link
	href='https://fonts.googleapis.com/css?family=Source+Sans+Pro:regular,italic,600,700,700italic|Poppins:regular,600,700'
	rel='stylesheet' type='text/css'>

<!-- Including default portal based script framework at the top -->
<script
	src="https://assets3.freshdesk.com/assets/cdn/portal_head-cc545c114f8f15358aa7acd4b9de11a5.js"
	type="text/javascript"></script>

<!-- Including syntexhighlighter for portal -->
<script
	src="https://assets8.freshdesk.com/assets/cdn/prism-67132b2e3f25bcb9d275fd76bf59f43c.js"
	type="text/javascript"></script>
...
<body>
	...
	<div class="alert alert-with-close notice" id="noticeajax"
				...
				<div class="container">
					<div class="container-inner">
						<ol class="breadcrumbs">
							<li title="자주 묻는 질문"><a href="<%=request.getContextPath() %>/myrealtrip/support/home.do?key=solution">자주 묻는 질문</a></li>
						</ol>
						<div class="header">
							<h1 class="h2">가입·변경·탈퇴</h1>
							...
							<section class="folder">
								<h3 class="h5 folder__title">
									<a class="folder__title-link"
										href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=5&ac_code=30">프로필</a>
								</h3>
								...
								<ul class="articles">
									...
									<li><a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=5&ac_code=30"
										class="see-all-articles"> 더보기 <img class="arrow-icon"
											width="16" height="16"
											src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/arrow-right-24.png"
			...
			<div class="container">
				<div class="container-inner">
					<div class="footer-buttons ">
						<span class="footer-buttons__text"> 도움이 더 필요하신가요? </span> <span
							class="footer-buttons__items"> <span
							class="footer-buttons__items-text">도움이 더 필요하신가요?</span> <span>
								<!--20190516 by WeDoSoft --> <!--a href="/support/tickets" class="btn btn-gray">문의내역</a-->
  ...
  (function($) {
	...
	<script
		src="https://assets1.freshdesk.com/assets/cdn/portal_bottom-fccb8c9aa071a0847726c1bb17225e9c.js"
		type="text/javascript"></script>
	<script
		src="https://assets5.freshdesk.com/assets/cdn/redactor-b5af0e7719dcfa84e7abd758b50900d3.js"
		type="text/javascript"></script>
	<script
		src="https://assets7.freshdesk.com/assets/cdn/freshfone_portal-c77b4da36df17dff45d679dc64445f39.js"
		type="text/javascript"></script>
	<script
		src="https://assets3.freshdesk.com/assets/cdn/lang/ko-c62c7d023f5cecf863628fa3fce02dd5.js"
		type="text/javascript"></script>
	<!-- for i18n-js translations -->
	<script
		src="https://assets9.freshdesk.com/assets/cdn/i18n/portal/ko-6411c85399930b87a1ee8ed7aca135ac.js"
		type="text/javascript"></script>
