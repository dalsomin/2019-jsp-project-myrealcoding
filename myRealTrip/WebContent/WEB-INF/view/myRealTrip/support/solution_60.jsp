...
<!-- Meta information -->
      ...
      <meta name="author" content="" />  <link rel="canonical" href="https://help.myrealtrip.com/support/solutions/43000360289" /> 
...
<meta content="6XycoJBfrjRHvyBPr4IUMPER2m3oxqyk+BDpptmg3a4=" name="csrf-token" />
		...
		<link href="https://assets5.freshdesk.com/assets/cdn/portal_print-ce4892062f25ebaf8abdcca87f6225b0.css" media="print" rel="stylesheet" type="text/css" />
		...
		<script src="https://assets6.freshdesk.com/assets/cdn/portal_head-cc545c114f8f15358aa7acd4b9de11a5.js" type="text/javascript"></script>
  ...
  <div class="container">
    <div class="container-inner">
      ...
      <div class="folder-tree">
          ...
          <c:forEach var="i" begin="17" end="21" step="1">
           ...
           <!-- title  -->
             <c:choose>
                      ...
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=17&ac_code=60">가이드(파트너)</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 18}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=18&ac_code=60">상품등록</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 19}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=19&ac_code=60">예약관리</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 20}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=20&ac_code=60">정산(송금)</a>
                      </h3>
                      </c:when>
                      <c:when test="${ i eq 21}">
                      <h3 class="h4 folder__title">
                        <a class="folder__title-link" href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=21&ac_code=60">좋은가이드되기</a>
                      </h3>
                      </c:when>
            ...
            <!-- title -->
              ...
              <ul class="articles">
                ...
                <li class="solutionmore" value="1" id="파트너"><a href="<%=request.getContextPath() %>/myrealtrip/support/folders.do?acd_code=${i}&ac_code=${param.ac_code}" class="see-all-articles">
...
<script>
  (function($) {
    ...
    $('.topbar a[href*="/support/profile/edit"]').parent('b').remove();
		...
		<script src="https://assets3.freshdesk.com/assets/cdn/lang/ko-c62c7d023f5cecf863628fa3fce02dd5.js" type="text/javascript"></script>
		<!-- for i18n-js translations -->
  		<script src="https://assets8.freshdesk.com/assets/cdn/i18n/portal/ko-6411c85399930b87a1ee8ed7aca135ac.js" type="text/javascript"></script>
