...
<!-- Title for the page -->
<title> 열림 또는 대기 중 : My Real Trip </title>
...
<!-- Meta information -->
      ...
      <meta name="author" content="" />  <link rel="canonical" href="https://help.myrealtrip.com/support/tickets" /> 
...
<meta content="8lF3SITKcL7clhyR9A2c8Y3v1Z8w3VwR1NK8L7uErXk=" name="csrf-token" />
		...
		<link href="https://assets7.freshdesk.com/assets/cdn/portal_print-ce4892062f25ebaf8abdcca87f6225b0.css" media="print" rel="stylesheet" type="text/css" />
	  		<link href="https://assets7.freshdesk.com/assets/cdn/falcon_portal_utils-fc010ba819d2d80256daa9858dbbc765.css" media="screen" rel="stylesheet" type="text/css" />	

		
		<!-- Theme stylesheet -->

		<link href="/support/theme.css?v=1557997475" media="screen" rel="stylesheet" type="text/css">
		...
		<script src="https://assets4.freshdesk.com/assets/cdn/portal_head-cc545c114f8f15358aa7acd4b9de11a5.js" type="text/javascript"></script>
		
		<!-- Including syntexhighlighter for portal -->
		<script src="https://assets5.freshdesk.com/assets/cdn/prism-67132b2e3f25bcb9d275fd76bf59f43c.js" type="text/javascript"></script>
	...
	<!-- google analytices ends here -->
		...
		<!-- Access portal settings information via javascript -->
		 <script type="text/javascript">     var portal = {"language":"ko","name":"My Real Trip","contact_info":"","current_page_name":"ticket_list","current_tab":"tickets","preferences":{"bg_color":"#f3f5f7","header_color":"#ffffff","help_center_color":"#f3f5f7","footer_color":"#183247","tab_color":"#ffffff","tab_hover_color":"#42a5f5","btn_background":"#f3f5f7","btn_primary_background":"#42a5f5","baseFont":"Source Sans Pro","textColor":"#183247","headingsFont":"Poppins","headingsColor":"#183247","linkColor":"#183247","linkColorHover":"#2753d7","inputFocusRingColor":"#42a5f5","nonResponsive":"true","personalized_articles":true},"image_placeholders":{"spacer":"https://assets6.freshdesk.com/assets/misc/spacer.gif","profile_thumb":"https://assets10.freshdesk.com/assets/misc/profile_blank_thumb-e1a34033b3073cb80f5becc0b644bfca.jpg","profile_medium":"https://assets10.freshdesk.com/assets/misc/profile_blank_medium-4ae2280a460eae3c870acb7a7545b7e5.jpg"},"falcon_portal_theme":true};     var attachment_size = 20;  </script> 
...
<div class="layout layout--logged-in  layout--ticket_list">
...
<header class="topbar  " data-topbar>
  ...
  <div class="topbar__head">
    <div class="topbar__container">
      <div class="topbar__nav">
        <button data-toggle-menu class="hamburger" type="button">
          <img width="24" height="24" src="data:image/png;base64," />
        </button>
      
        <div class="topbar__wrapper">
          <a class="logo" href="/support/home">
            <img src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/Color.png"
                srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/Color.png 1x, https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/Color%402x.png 2x"
                alt="">
          </a>
          <div class="topbar__search" data-topbar-search>
            <form class="hc-search-form" autocomplete="off" action="/support/search/tickets" id="hc-search-form">
	<div class="hc-search-input">
	<label for="support-search-input" class="hide">궁금한 내용, 질문, 오류상황 등 검색어를 입력하세요.</label>
		<input placeholder="궁금한 내용, 질문, 오류상황 등 검색어를 입력하세요." type="text" 
	...
	<div class="hc-search-button">
        ...
        <button 
          ...
          <img width="24" height="24" 
              src="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/Color.png"
              srcset="https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/gray-700.png 1x,  https://d2ur7st6jjikze.cloudfront.net/freshdesk_myrealtrip/gray-700%402x.png 2x"
              alt="">
        </button>
      
        <div data-menu class="topbar__controls topbar__controls--logged-in">
          <!--20190516 by WeDoSoft -->
          <!--a class="btn btn-topbar" href="/support/tickets">문의 내역</a-->
          
           <div class="welcome">환영합니다. <b>지승연</b> </div>  | <b><a href="/support/profile/edit">프로필 수정</a></b> - <b><a href="/logout">로그아웃</a></b>
        </div>
      </div>
    </div>
  </div>
      ...
      <nav class="topbar-categories">
        <ul class="topbar-categories__list">
          ...
          <li class="topbar-categories__item topbar-categories__item--">
            <a class="topbar-categories__link js-topbar-categories-link" href="/support/solutions" data-category="0">자주 묻는 질문
            </a>
          </li>
            ...
            <li class="topbar-categories__item topbar-categories__item--43000360286"  >
              <a class="topbar-categories__link js-topbar-categories-link" data-category="43000360286" href="/support/solutions/43000360286">예약·변경·취소</a>
            </li>
          
          
          
            <li class="topbar-categories__item topbar-categories__item--43000360287"  >
              <a class="topbar-categories__link js-topbar-categories-link" data-category="43000360287" href="/support/solutions/43000360287">가입·변경·탈퇴</a>
            </li>
          
          
          
            <li class="topbar-categories__item topbar-categories__item--43000360288"  >
              <a class="topbar-categories__link js-topbar-categories-link" data-category="43000360288" href="/support/solutions/43000360288">이용·후기·혜택</a>
            </li>
          
          
          
            <li class="topbar-categories__item topbar-categories__item--43000360290"  >
              <a class="topbar-categories__link js-topbar-categories-link" data-category="43000360290" href="/support/solutions/43000360290">실시간 항공</a>
            </li>
          
          
          
            <li class="topbar-categories__item topbar-categories__item--43000360289"  >
              <a class="topbar-categories__link js-topbar-categories-link" data-category="43000360289" href="/support/solutions/43000360289">파트너</a>
            </li>
  ...
  <div class="container-inner">
    <div class="ticket-list-page">
      ...
      <div class="ticket-filter-container ticket-toolbar" id="ticket-filter-container">
        <div id="ticket-toolbar">
  <div class="dropdown" id="ticket-filters">  
  	<a href="#" class="list-lead dropdown-toggle" data-toggle="dropdown">
  	열림 또는 대기 중 <i class="caret"></i>
  	</a>
    <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu"><li><a href="/support/tickets/filter?requested_by=0&amp;wf_filter=all" data-loading-box="#ticket-list" data-method="get" data-remote="true" data-response-type="script">모든 티켓</a></li><li class="selected" ><span class='icon ticksymbol'></span><a href="/support/tickets/filter?requested_by=0&amp;wf_filter=open_or_pending" data-loading-box="#ticket-list" data-method="get" data-remote="true" data-response-type="script">열림 또는 대기 중</a></li><li><a href="/support/tickets/filter?requested_by=0&amp;wf_filter=resolved_or_closed" data-loading-box="#ticket-list" data-method="get" data-remote="true" data-response-type="script">해결됨 또는 닫힘</a></li></ul>
  </div>
  <div id="ticket-sub-toolbar">
    <span id="ticket-sort" class="dropdown">
      <ul class="dropdown-menu " role="menu" aria-labelledby="dropdownMenu"><li class="selected" ><span class='icon ticksymbol'></span><a href="/support/tickets/filter?wf_order=created_at" data-loading-box="#ticket-list" data-method="get" data-remote="true" data-response-type="script">작성 일자</a></li><li><a href="/support/tickets/filter?wf_order=updated_at" data-loading-box="#ticket-list" data-method="get" data-remote="true" data-response-type="script">마지막 수정</a></li><li><a href="/support/tickets/filter?wf_order=status" data-loading-box="#ticket-list" data-method="get" data-remote="true" data-response-type="script">처리 상태</a></li><li class="divider"></li><li><a href="/support/tickets/filter?wf_order_type=asc" data-loading-box="#ticket-list" data-method="get" data-remote="true" data-response-type="script">증가</a></li><li class="selected" ><span class='icon ticksymbol'></span><a href="/support/tickets/filter?wf_order_type=desc" data-loading-box="#ticket-list" data-method="get" data-remote="true" data-response-type="script">감소</a></li></ul>
      ...
      <div id="ticket-list">
		<div class="c-list">
				<div class="c-row c-ticket-row">
					<span class="status-source sources-detailed-portal" 
							 title="포털 채널을 통해 보고됨"> </span>
					<span class="label-status-pending label label-small">
						처리 중
					</span>
					<div class="ticket-brief">
					    <div class="ellipsis">
					      	<a href="/support/tickets/371168" class="c-link" title="문의내역은 어디서 확인할 수 있나요?">문의내역은 어디서 확인할 수 있나요? #371168</a> 
					    </div>
					    <div class="help-text">
								<span class='emphasize'>목, 23 5월 at  7:00 PM</span>에 생성됨
	...
	<script type='text/javascript'>
	  ...
	  var exportLink = '<a href="/support/tickets/configure_export" data-target="#export-modal" id="ticket-export-button" rel="freshdialog" data-submit-label="내보내기" title="티켓 내보내기" data-close-label="닫기">티켓 내보내기</a>'
	  jQuery(".ticket-toolbar").append(exportLink);

		jQuery("#ticket-export-button").toggle(true)
	</script>
</div>
    </div>
  </div>
...
<script>
  (function($) {
    ...
    $('.topbar a[href*="/support/profile/edit"]').parent('b').remove();
		...
		<script src="https://assets8.freshdesk.com/assets/cdn/redactor-b5af0e7719dcfa84e7abd758b50900d3.js" type="text/javascript"></script>
		<script src="https://assets9.freshdesk.com/assets/cdn/freshfone_portal-c77b4da36df17dff45d679dc64445f39.js" type="text/javascript"></script>	
		<script src="https://assets6.freshdesk.com/assets/cdn/lang/ko-c62c7d023f5cecf863628fa3fce02dd5.js" type="text/javascript"></script>
		<!-- for i18n-js translations -->
  		<script src="https://assets5.freshdesk.com/assets/cdn/i18n/portal/ko-6411c85399930b87a1ee8ed7aca135ac.js" type="text/javascript"></script>
