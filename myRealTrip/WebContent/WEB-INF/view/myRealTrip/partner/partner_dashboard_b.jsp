...
<c:if test="${Tour eq true || Ticket eq true }">
...
<a class='btn btn-dark btn-outline font-weight-700 margin-left-10' download='에어텔/항공권 매뉴얼' href='https://s3-ap-northeast-1.amazonaws.com/myrealtrip/partner_docs/mrt_hot_deal_partner_manual.pdf'>
<i aria-hidden='true' class='icon wb-link-intact'></i>
에어텔/항공권 매뉴얼
</a>
</c:if>
...
<a class='btn btn-default btn-info offer-register-btn margin-top-10' href='<%=request.getContextPath() %>/partner/regist_tour1.do'>
<i aria-hidden='true' class='icon wb-plus'></i>
가이드 투어 등록
</a>
</c:if>
<c:if test="${Ticket eq true }">
<a class='btn btn-default btn-info offer-register-btn margin-top-10' href='/partner/offers/new?offer%5Btype%5D=DeliveryTicket'>
<i aria-hidden='true' class='icon wb-plus'></i>
배송 티켓 등록
</a>
<a class='btn btn-default btn-info offer-register-btn margin-top-10' href='/partner/offers/new?offer%5Btype%5D=ETicket'>
<i aria-hidden='true' class='icon wb-plus'></i>
e티켓 등록
</a>
</c:if>
<c:if test="${HotDeal eq true }">
<button class='btn btn-default btn-info offer-register-btn margin-top-10' data-target='#hotdealTemplateModal' data-toggle='modal' type='button'>
<i aria-hidden='true' class='icon wb-plus'></i>
에어텔/항공권 등록
</button>
<div aria-hidden='true' aria-labelledby='hotdealTemplateModal' class='modal fade' id='hotdealTemplateModal' role='dialog' tabindex='-1'>
<div class='modal-dialog modal-center'>
<form class="modal-content" data-validation="true" action="/partner/documents" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="2jeaa9HGQbdbIHstKtbMJGy6vHg+J1kVuLeqFbbjvpj4F/PYKGYMahb8tFuYnRb72LnHN6E1YyJabB+WVkY/5w==" />
<div class='modal-header'>
<button aria-label='Close' class='close' data-dismiss='modal' type='button'>
<span aria-hidden='true'>×</span>
</button>
<h4 class='modal-title'>에어텔/항공권 등록</h4>
</div>
<div class='modal-body font-size-14'>
<div class='form-group clearfix'>
<p>에어텔/항공권을 등록하시려면 먼저 '요청서 템플릿'을 다운로드하시고 내용을 채워주세요. 내용이 모두 준비되면 아래 '요청서 업로드' 버튼을 눌러 파일을 업로드해주세요.<br/></p>
<a class='btn btn-outline btn-dark' download='요청서 템플릿 다운로드' href='https://s3-ap-northeast-1.amazonaws.com/myrealtrip/partner_docs/mrt_hotdeal_request_form.xlsx'>
<i aria-hidden='true' class='icon wb-link-intact'></i>
요청서 템플릿 다운로드
</a>
<div class='row'>
<div class='col-xs-12'>
<label class='control-label margin-top-30'>요청서 업로드</label>
</div>
<div class='col-xs-12'>
<div class='file-upload-btn inline-block' data-display-file-name data-document-button-container>
<input name='document[document_file_temp_url]' type='hidden' value=''>
<input name='document[type]' type='hidden' value='hotdeal_request'>
<input accept='.csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel' name='file' type='file'>
...
<c:if test="${Lodging eq true }">
<a class='btn btn-default btn-info offer-register-btn margin-top-10' href='<%=request.getContextPath()%>/partner/regist_minbak.do'>
<i aria-hidden='true' class='icon wb-plus'></i>
민박 등록
</a>
</c:if>
...
<div class='row'>
<div class='col-xs-12'>
<div class='help-message margin-top-20'>• 작성 중인 상품은 왼쪽 상품 관리에서 계속 진행하실 수 있습니다. 상품을 제출하면 이 단계가 완료됩니다.<br/></div>
</div>
</div>
</div>
</div>
...
<div class='file-upload-btn inline-block' data-document-button-container data-is-required data-is-unique data-need-reload data-type='passbook_copy' data-upload-directly data-url='/smalltalk/partner/documents'>
<input name='file' type='file'>
<button class='btn btn-default btn-file btn-info ladda-button offer-register-btn' data-spinner-color='DarkGray' data-style='zoom-out'>
<span class='ladda-label'></span>
<i aria-hidden='true' class='icon wb-upload'></i>
통장 사본 업로드
</button>
</div>
<div class='file-upload-btn inline-block' data-document-button-container data-is-required data-is-unique data-need-reload data-type='business_license' data-upload-directly data-url='/smalltalk/partner/documents'>
<input name='file' type='file'>
...
<div class='col-xs-1'>
<div class='padding-left-10'>
<h2 class='process-num'>5</h2>
<i aria-hidden='true' class='icon wb-check process-check green-600'></i>
</div>
</div>
<div class='col-xs-11'>
<label class='control-label font-weight-700 margin-top-20'>정산 계좌 등록</label>
<div>수익이 발생할 경우 수취할 계좌를 등록해주세요.</div>
<div class='row'>
<div class='panel-btn-container margin-top-10 clearfix'>
<div class='col-xs-12'>
<a class='btn btn-default btn-info margin-top-10 offer-register-btn' href='/partner/bank'>
<i aria-hidden='true' class='icon wb-pencil'></i>
정산 계좌 등록
</a>
</div>
...
<div class='panel-btn-container margin-top-10 clearfix'>
<div class='col-xs-12'>
<a class='btn btn-default btn-info margin-top-10 offer-register-btn' href='/partner/quiz'>
<i aria-hidden='true' class='icon wb-pencil'></i>
퀴즈 풀기
</a>
</div>
...
<div class='modal-dialog modal-center'>
<form class="modal-content" data-validation="true" action="/partner/documents" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="zlY4NKw5LMRrfKVrcds6B3WR3dulqnGUAczlbR75uO/sdlGHVZlhGSagah3DkODYwZKmlDq4S6PjF1Du/lw5kA==" />
<div class='modal-header'>
<button aria-label='Close' class='close' data-dismiss='modal' type='button'>
<span aria-hidden='true'>×</span>
</button>
...
<script>
  window.App = App || {};
  App.directUpload = {
    option: {"key":"uploads/136c4c49-d4c7-492d-82b5-9eb88f771c52/${filename}","success_action_status":"201","acl":"public-read","policy":"","x-amz-credential":"AKIAIXN6CY4DE66SKDHQ/20190604/us-east-1/s3/aws4_request","x-amz-algorithm":"AWS4-HMAC-SHA256","x-amz-date":"20190604T013645Z","x-amz-signature":"359462181398744d3b585a7852d37adc915bb9d9a591495a9dd8ab4be95905c9"},
