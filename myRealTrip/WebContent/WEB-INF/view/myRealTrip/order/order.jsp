...
<meta name="csrf-token" content="Hvi+C212MlYiUNBBZzZ0W0SNXX8oZgm0t50vQAgBNG2MEGly1o/kRLgMvykR/GAFzj0eIx/yFCYZ0wPAiI/a3w==" />
...
<meta content='https://www.myrealtrip.com/offers/35776/reservations/new?choice_set[begin_at]=2019-06-20&amp;choice_set[choices][][key]=14156724&amp;choice_set[choices][][travelers]=1' property='og:url'>
...
<section class='body-container clearfix bg-gray' data-request-url='/offers/35776/occupied_dates'>
<div class='twin-container row'>
<form id="reservation_form" data-validation="true" action="pay.do" accept-charset="UTF-8" method="post">

<input name="options" type="hidden" value="${param.code }" />
<input type="hidden" name="p_code" value="${param.p_code }" />
...
<div class='panel-body' data-amount='432000.0' data-city-length='1' data-city='Interlaken' data-country='Switzerland' data-currency='KRW' data-id='35776' data-price='432000.0' data-type='HotDeal' id='reservation-order-result'>
<div class='title'>${pInfo.p_name }</div>
<div class='profile'>
<img class='img-circle' src='https://d2ur7st6jjikze.cloudfront.net/profile_images/638538/638538_original_1512531348.png?1512531348'>
...
<div class='panel-body panel-body-border' id="totalprice">
...
<input autocomplete='off' class='form-control' data-offer-id='35776' data-url='/traveler/coupons' id='promotion-coupon-input' name='promotion_coupon_code' placeholder='할인쿠폰코드 입력' type='text'>
...
<div class='control-label col-xs-12'>
<span>쿠폰</span>
<span class='font-blue font-bold' data-coupon-count='1'>1개</span>
</div>
</div>
<div class='row'>
<div class='col-xs-12'>
...
<option data-coupon='2000.0' value='6140416'>가입축하 2천원 할인쿠폰 (₩ 2,000)</option>
</select>
...
<div class='pull-right price-container' id="price22"></div>
</div>
</div>
<input type="hidden" value="" name="price" id="totprice">
</div>
<script>
...
<div class='col-xs-9'>
<input autocomplete='off' class='form-control' id='input-email' name='e-mail' value='${memberInfo[0] }'>
</div>
</div>
<div class='row'>
<div class='col-xs-3 control-label'>이메일 주소 확인</div>
<div class='col-xs-9'>
<input autocomplete='off' class='form-control' id='input-email-confirm' name='e-mail' value='${memberInfo[0] }'>
</div>
</div>
</div>
...
<div class='col-xs-12 control-title'>
<span>구매자 여권 정보</span>
<span class='font-blue help-message'>(이용하시는 모든 분의 정보를 여권 상과 동일하게 기입해주시기 바랍니다.)</span>
</div>
</div>

<div class='row'>
<div class='col-xs-3 control-label'>영어 이름</div>
<div class='col-xs-9'>
<input class='form-control' name='ename' placeholder='Hong Gil Dong' type='text'>
</div>
</div>
<div class='row'>
<div class='col-xs-3 control-label'>한국 이름</div>
<div class='col-xs-9'>
<input class='form-control' name='kname' placeholder='홍길동' type='text'>
</div>
</div>
<div class='row'>
<div class='col-xs-3 control-label'>성별</div>
<div class='col-xs-9'>
<select class='form-control' id='input-icc' name='gender' title='성별'>
...
<div class='row'>
<div class='col-xs-3 control-label'>생년월일</div>
<div class='col-xs-9'>
<input class='form-control' name='birthday' placeholder='예시) 881225' type='text'>
</div>
</div>
</div>
...
<div id='zipcode-layer'></div>
<img id='btn-close-layer' src='//i1.daumcdn.net/localimg/localimages/07/postcode/320/close.png'>
</div>
...
<div class='row'>
<div class='col-xs-5'>
<select class='form-control' name='p_nation' title='국가번호'>
...
<div class='row'>
<div class='col-xs-12'>
<select class='form-control' name='age' title='연령대'>
...
<div class='row'>
<div class='col-xs-12'>
<select class='form-control' name='purpose' title='여행컨셉'>
<option disabled selected>여행 목적을 선택해주세요(필수)</option>
<option value='혼자 떠나는 여행'>혼자 떠나는 여행</option>
<option value='친구들과 떠나는 여행'>친구들과 떠나는 여행</option>
<option value='연인과 함께 떠나는 로맨틱한 여행'>연인과 함께 떠나는 로맨틱한 여행</option>
<option value='허니문'>허니문</option>
<option value='배우자와 단 둘이 떠나는 여행'>배우자와 단 둘이 떠나는 여행</option>
<option value='부모님과 떠나는 여행'>부모님과 떠나는 여행</option>
<option value='자녀와 함께 떠나는 여행'>자녀와 함께 떠나는 여행</option>
<option value='출장, 학회'>출장, 학회</option>
...
<div class='control-label col-xs-12'>
추가정보
<div class='col-xs-12 font-blue help-message'>@@@</div>
</div>
</div>
<div class='row'>
<div class='col-xs-12'>
...
<input name='reservation_uuid' type='hidden' value='c1a3f9b4-9522-4c06-b806-b94ca1db819d'>
<div class='panel-heading'>
<div class='title'>
...
<input checked='checked' id='type-wcard' name='payment' type='radio' value='wcard'>
<label for='type-wcard'>신용카드 결제</label>
</div>
</div>
<div class='clearfix'>
<div class='radio-custom radio-primary'>
<input id='type-bank' name='payment' type='radio' value='bank'>
<label for='type-bank'>실시간계좌이체</label>
</div>
</div>
<div class='clearfix'>
<div class='radio-custom radio-primary'>
<input id='type-vbank' name='payment' type='radio' value='vbank'>
<label for='type-vbank'>무통장 입금</label>
</div>
</div>
<div class='clearfix'>
<div class='radio-custom radio-primary'>
<input id='type-toss' name='payment' type='radio' value='toss'>
<label for='type-toss'>
토스계좌결제
...
<div class='clearfix'>
<div class='radio-custom radio-primary'>
<input id='type-naverpay' name='payment' type='radio' value='naverpay'>
...
<strong class='no-refund'>해당 상품은 취소 및 환불이 불가능한 상품입니다.</strong>
</div>
</div>

<div class='btn-container form-btn-container clearfix'>
<div class='btn--width-50'>
<a class="btn-new btn--type-gray btn--width-100" href="/offers/35776">취소하기</a>
</div>
<div class='btn--width-50'>
<button class='btn-new btn--type-primary btn--width-100' data-disable-with='로딩중..' id='reservation-btn' type="button">결제하기</button>
</div>
</div>
</div>
</form>
...
<script>
  ...
  dataLayer.push({
    ...
    'offer_id': 35776,
    'offer_amount': 432000,
    'offer_name': "★★스위스패스 최저가딜★★★ Quick E-ticket 써프라이즈Price! 당일발급가능",
    'offer_type': "HotDeal",
