...
public class File_Minbak1Handler implements CommandHandler{
	...
	private String fileupload(HttpServletRequest request, HttpServletResponse response) {
		...
		String saveDirectory= request.getRealPath("/img/minbak"); 
	...
	//	int c_code=77;
		...
		System.out.println(js);
				return "/partner/regist_item/ajax/minbakfileajax_1";
	}
